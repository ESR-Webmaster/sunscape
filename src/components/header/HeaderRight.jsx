	...
	return (
		<div className="right">
			...
			<div className="right-content">
				...
				<div className="flags">
					{[CottageTwoToneIcon, BoltTwoToneIcon, ElectricMeterTwoToneIcon, SolarPowerTwoToneIcon, ElectricBoltTwoToneIcon, EnergySavingsLeafTwoToneIcon].map((Icon, index) => (
						<div
							key={index}
							className="flag-box"
						...
						>
							<div
								className="flag"
								style={{
									transform: `scale(${index % 2 !== 0 ? '0.9' : '1'}) translate(-50%, 0) rotate(${index * -60}deg)`,
								}}
							>
								<Icon />
							</div>
